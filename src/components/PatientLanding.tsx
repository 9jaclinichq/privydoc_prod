...
export default function PatientLanding({
  ...
  return (
    <div className="space-y-16 animate-slide-up">
      {/* Desktop: hero on the left, condition cards on the right. Mobile/tablet: stacked. */}
      <div className="lg:grid lg:grid-cols-2 lg:gap-10 lg:items-center">

        {/* Visual Header / Splash Hero Card */}
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-zinc-900/60 to-black border border-zinc-900 px-6 py-16 text-center lg:text-left space-y-6 shadow-2xl">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-[10px] font-bold text-[#E5C158] uppercase tracking-widest mx-auto lg:mx-0">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 max-w-lg mx-auto lg:mx-0">
            {patientSession ? (
